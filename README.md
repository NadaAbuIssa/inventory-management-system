...
| PUT /addresses/{id}                          | Update/Replace | Update a specific address by ID | 200 OK: The request was successful<br>400 Bad Request: The request body is missing or contains invalid parameters | {"street":"456 ABC", "city":"Nablus", "state":"West Bank", "country":"Palestine"}                | {"id": 1, "street":"456 ABC D", "city":"Nablus", "state":"West Bank", "country":"Palestine"} |
| PATCH /addresses/{id}                          | Partial Update/Modify   | Partially update a specific address  | 200 OK: The request was successful<br>400 Bad Request: The request body is missing or contains invalid parameters | {"city":"Bethlehem"} | {"id": 1, "street":"123 Main St", "city":"Bethlehem", "state":"West Bank", "country":"Palestine"} |
...
| PUT /transactions/{id}                          | Update/Replace | Update a specific transaction by ID | 200 OK: The request was successful<br>400 Bad Request: The request body is missing or contains invalid parameters | {"user_involved_id": 1, "item_affected_id": 2, "quantity": 8, "date": "2024-04-05T14:15:00Z", "address_id": 3}               | {"id": 1, "user_involved_id": 1, "item_affected_id": 2, "quantity": 8, "date": "2024-04-05T14:15:00Z", "address_id": 3}  |
| PATCH /transactions/{id}                          | Partial Update/Modify   | Partially update a specific transaction by ID   | 200 OK: The request was successful<br>400 Bad Request: The request body is missing or contains invalid parameters  | {"quantity": 10}| {"id": 1, "user_involved_id": 1, "item_affected_id": 2, "quantity": 10, "date": "2024-04-07T10:30:00Z", "address_id": 3} |
